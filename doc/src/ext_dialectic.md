...
If this also affects a relation, an element can mark one of its relation as defeated using: `defeatedRelation: G1`.
...
![Rendered First Example](examples/dialectic/first.gsn.svg)

```yaml
{{#include examples/dialectic/second.gsn.yaml}}
```

## Rendered Second Example

![Rendered Second Example](examples/dialectic/second.gsn.svg)
