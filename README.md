...
The tool automatically performs the following validation checks on the input YAML:
 ...
 - V07: All elements listed as extending other elements must be known elements of the current module.
 ...
 - C09: All extended modules exist.
 - C10: All extended elements exist in the named modules.
